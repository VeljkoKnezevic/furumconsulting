...
Cal.com booking (step 2 of 2), an ROI calculator, what you'll learn on the call,
and the offer.
...
- `src/pages/index.astro` - the entire funnel: hero, video step, booking step, ROI calculator, learn section, offer, and CTA.
